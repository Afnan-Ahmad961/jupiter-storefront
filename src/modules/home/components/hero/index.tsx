...
const Hero = () => {
  return (
    <div className="h-screen w-full relative overflow-hidden">
      ...
      <div className="absolute inset-x-0 bottom-0 pb-12 small:pb-24">
        <div className="content-container flex flex-col small:flex-row justify-between items-end gap-y-8">
          {/* Left Side Text */}
          <div className="text-white max-w-xl">
            <h1 className="text-3xl small:text-5xl font-bold uppercase tracking-tight mb-4">
              Kith for the NFL: Road to Victory
            </h1>
            <p className="text-base small:text-lg font-medium opacity-90 max-w-md leading-relaxed">
